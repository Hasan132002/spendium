...
<div class="max-w-3xl mx-auto p-6">
    ...
    <form id="chat-form">
        <div class="flex flex-col gap-3">
            <select id="table_name" name="table_name" class="border p-2 rounded" required>
                ...
                <option value="loan_contributions">Loan Contributions</option>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener("submit", function(e) {
        ...
        const table_name = tableSelect.value;

        if (!question || !table_name) {
            alert("Please select table and type question.");
            return;
        }
        ...
        fetch("/admin/ai/ask", {
            ...
            body: JSON.stringify({ question: question, table_name: table_name })
        })
        .then(res => res.json())
        .then(data => {
