    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        <nav>
            <ol class="flex items-center gap-1.5">
                ...
                <li class="text-sm text-gray-800 dark:text-white/90">{{ __('Family Requests') }}</li>
            </ol>
        </nav>
    </div>
            ...
            <div class="overflow-x-auto border-t border-gray-100 dark:border-gray-800">
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-4 text-gray-500 dark:text-gray-400">{{ __('No family requests found') }}</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
